<div
    {{ $attributes->merge(['class' => 'flex flex-col items-start justify-center bg-white  h-[80px] border-b border-gray-200']) }}>
    @if (session()->has('success'))
        <div
            class="notification bg-white py-1 px-6 rounded-full flex gap-x-1 items-center py-2 justify-center border border-gray-200 shadow-lg text-green-500 font-bold absolute top-4 left-2 z-[999]">
